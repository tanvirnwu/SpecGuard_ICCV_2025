...
def main():
    ...
    new_run_parser.add_argument('--watermark-radius', type=int, default=10,
                                help='Radius for the Tree-Ring watermark in Fourier space.')
    new_run_parser.add_argument('--watermark-value', type=float, default=1.0,
                                help='Value/intensity for the Tree-Ring watermark in Fourier space.')
    ...
    if args.command == 'continue':
        ...
        hidden_config = HiDDenConfiguration(
            ...
            encoder_blocks=8, encoder_channels=128,
            decoder_blocks=8, decoder_channels=256,
            use_discriminator=True,
            use_vgg=False,
            discriminator_blocks=8, discriminator_channels=64,
            decoder_loss=1,
            encoder_loss=0.7,
            ber_loss_weight = 0.5,
            adversarial_loss=1e-3,
            watermark_radius=args.watermark_radius,
            watermark_value=args.watermark_value,
