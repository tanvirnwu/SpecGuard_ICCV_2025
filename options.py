...
class HiDDenConfiguration:
    ...
    def __init__(self, H: int, W: int, message_length: int,
                 ...
                 decoder_loss: float,
                 encoder_loss: float,
                 ber_loss_weight: float,
                 adversarial_loss: float,
                 watermark_radius: int, watermark_value: float,
        ...
        self.ber_loss_weight = ber_loss_weight
        self.adversarial_loss = adversarial_loss
        self.watermark_radius = watermark_radius  # Radius for Fourier embedding
        self.watermark_value = watermark_value  # Value for the embedded watermark in Fourier space
